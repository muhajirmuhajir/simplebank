...
// Steps : Create Transfer record, add account entries, and update accounts balance
...
func updateAccountBalance(ctx context.Context, q *Queries, account1, amount1, account2, amount2 int64) (result1, result2 Account, err error) {

	result1, err = q.AddAccountBalance(ctx, AddAccountBalanceParams{
		ID:     account1,
		Amount: amount1,
	})
	if err != nil {
	...
	result2, err = q.AddAccountBalance(ctx, AddAccountBalanceParams{
		ID:     account2,
		Amount: amount2,
	})
	if err != nil {
